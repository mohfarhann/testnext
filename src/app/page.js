            ...
            <div className="flex flex-col items-center justify-center gap-8">
              <div className="w-full text-center">
                ...
                <p className="md:text-2xl md:mb-8">
                  Nikmati berbagai permainan judi online seperti slot, taruhan
                  bola, dan live casino. Daftar sekarang dan dapatkan welcome
                  bonus hingga Rp 20.000.000!
                </p>
                ...
                <div className="flex flex-col items-center justify-between gap-8">
                  <div className="w-full flex flex-col items-start justify-between gap-4">
                    ...
                    <h1 className="text-2xl font-bold">
                      Permainan Real-Time bersama live dealer
                    </h1>
                    <p>
                      Rasakan sensasi bermain live casino seperti Blackjack,
                      Roulette, dan Baccarat langsung dengan live dealer.
                    </p>
                  ...
                  <div className="w-full flex flex-col items-start justify-between gap-4">
                    ...
                    <h1 className="text-2xl font-bold">
                      Mesin slot online dengan RTP tinggi
                    </h1>
                    <p>
                      Mainkan ratusan mesin slot online dengan tema unik dan
                      fitur bonus yang menarik di BK8.
                    </p>
                    <div className="flex flex-col items-center justify-between gap-2">
                      <div className="flex flex-row items-center justify-start gap-2 w-full">
                        <HiMiniCheck />
                  ...
                  <div className="w-full flex flex-col items-start justify-between gap-4">
                    ...
                    <p>
                      Pasang taruhan Anda pada berbagai jenis olahraga dan
                      kompetisi di seluruh dunia di BK8.
                    </p>
                    <div className="flex flex-col items-center justify-between gap-2">
                      <div className="flex flex-row items-center justify-start gap-2 w-full">
                        <HiMiniCheck />
              ...
              <div className="w-full h-full">
                <div className="w-full">
                  ...
                  <p className="text-xs md:text-base">
                    Save time and improve productivity with a customizable
                    workflow, allowing you to automate repetitive tasks and
                  ...
                  <div className="flex flex-col md:grid md:grid-cols-3 items-center justify-between gap-4 mt-8">
                    <div className="w-full flex-col items-center justify-start gap-8 bg-white p-4 rounded-md">
                      ...
                      <div className="mt-2">
                        ...
                        <p className="text-xs mt-2">
                          Nikmati proses deposit dan withdraw dalam hitungan
                          menit.
                        </p>
                      </div>
                    </div>
                    <div className="md:w-[285px] md:h-[180px] flex-col items-center justify-start gap-8 bg-white p-4 rounded-md">
                      ...
                      <div className="mt-2">
                        ...
                        <p className="text-xs mt-2">
                          Platform kami menggunakan teknologi enkripsi SSL
                          128-bit.
                        </p>
                      </div>
                    </div>
                    <div className="md:w-[285px] md:h-[180px] flex-col items-center justify-start gap-8 bg-white p-4 rounded-md">
                      ...
                      <div className="mt-2">
                        ...
                        <p className="text-xs mt-2">
                          Dari slot, taruhan bola, hingga live casino, kami
                          memiliki semuanya.
                        </p>
                      </div>
                    </div>
                    <div className="md:w-[285px] md:h-[180px] flex-col items-center justify-start gap-8 bg-white p-4 rounded-md">
                      ...
                      <div className="mt-2">
                        ...
                        <p className="text-xs mt-2">
                          Dapatkan bantuan 24/7 dari tim layanan pelanggan
                          profesional.
                        </p>
                      </div>
                    </div>
                    <div className="md:w-[285px] md:h-[180px] flex-col items-center justify-start gap-8 bg-white p-4 rounded-md">
                      ...
                      <div className="mt-2">
                        ...
                        <p className="text-xs mt-2">
                          Bermain di mana saja dan kapan saja melalui aplikasi
                          mobile.
                        </p>
                      </div>
                    </div>
                    <div className="md:w-[285px] md:h-[180px] flex-col items-center justify-start gap-8 bg-white p-4 rounded-md">
                      ...
                      <div className="mt-2">
                        ...
                        <p className="text-xs mt-2">
                          Berbagai bonus, promosi dan event menarik setiap
                          harinya.
                        </p>
                      </div>
                    </div>
              ...
              <div className="w-full h-full mt-8">
                <div className="w-full mx-auto">
                  ...
                  <div className="flex flex-col items-center justify-between gap-2">
                    ...
                    <FAQ
                      question={
                        "2. Bagaimana cara mendaftar dan bermain di BK8?"
                      }
                      answer={
                    ...
                    <FAQ
                      question={
                        "11. Bagaimana BK8 menjaga keamanan data pribadi saya?"
                      }
                      answer={
                        "Kami menggunakan teknologi keamanan terkini, seperti enkripsi data SSL dan firewall yang kuat, untuk melindungi informasi pribadi dan transaks pemain kami. "
                      }
                    />
                  </div>
                </div>
